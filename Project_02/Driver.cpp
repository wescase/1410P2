...
int main()
{
	...
	Person p1 = Person::Person("Margan A.", "1234 Street");
	Person p2 = Person::Person("Wes C.", "4321 Cir.");
	Person p3 = Person::Person("Homer Simpson", "5748 Springfield");
	...
	Account a1 = Account::Account(p1, 500.00, 1);
	Account a2 = Account::Account(p2, 1000.00, 2);
	Account a3 = Account::Account(p3, 1200.00, 3);
